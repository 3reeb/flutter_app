...
The JSON manifests are paired with direct Dart behavior tests in `test/generated/sdui_json_runtime_behavior_test.dart`. Those tests compile real SDUI nodes and verify the runtime snapshot APIs.
