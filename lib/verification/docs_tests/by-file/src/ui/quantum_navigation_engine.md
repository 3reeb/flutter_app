...
source_sha256: 165af6322fec80fdb810fc63f00a0bb7b8f83565fb7d40974b9a86a4d693621a
source_line_count: 1039
...
# Test Specification: `src/ui/quantum_navigation_engine.dart`
...
- `_QLHardwarePage`
- `_QLHardwareRoute`
- `_QLZeroRebuildTransition`
- `_QLZeroRebuildTransitionState`
- `_QLAsyncSchemaView`
- `_QLAsyncSchemaViewState`
- `QLTransitionType`
- `QLDataFetchCallback`
- `QLSeoBuilder`
- `QLWidgetBuilder`
...
- dependency `quantum_hydration_reader.dart` should be validated as a potential compatibility boundary.
...
- dependency `quantum_components.dart` should be validated as a potential compatibility boundary.
- local dependency `../../quantum.dart` is part of the integration surface and should be tested alongside this file.

## YAML companion

- Base manifest: `docs_tests/yaml/by-file/src/ui/quantum_navigation_engine.dart.yaml`
