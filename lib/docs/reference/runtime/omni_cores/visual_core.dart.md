...
- Line 3: `QLBlueprint _visualCloneAs(` — Part of the public or internal API; it is named `_visualCloneAs` and contributes to this file’s behavior.
- Line 22: `Widget _buildVisual(QLContext rawCtx) {` — Part of the public or internal API; it is named `_buildVisual` and contributes to this file’s behavior.
- Line 277: `void _registerVisualAliases(QuantumVM vm) {` — Part of the public or internal API; it is named `_registerVisualAliases` and contributes to this file’s behavior.
