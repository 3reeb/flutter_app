...
## What this file is
The main configuration source for the framework. It defines the root config object and serves as the canonical place where app, API, security, merge, cache, source, and build-overlay settings are composed.
