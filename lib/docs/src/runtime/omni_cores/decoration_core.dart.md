...
Author-intent note: QUANTUM OMNI REGISTRY — DECORATION ENGINE

## Dependencies
- part of '../quantum_omni_registry.dart';

## Top-level declarations
- Line 12: `Widget _buildDecoration(QLContext rawCtx) {` — Part of the public or internal API; it is named `_buildDecoration` and contributes to this file’s behavior.
- Line 208: `void _registerDecorationAliases(QuantumVM vm) {` — Part of the public or internal API; it is named `_registerDecorationAliases` and contributes to this file’s behavior.
