...
The checked-in fixture set now spans 300 JSON execution cases across the layout, runtime, and overlay folders so the suite covers a broad production-shaped surface, not just a handful of toy examples.
...
Overlay fixtures live under `cases/overlay/` and cover portal-driven overlays, floating surfaces, inline panels, toasts, and fullscreen presentations with live execution checks.
