/*
 * ============================================================================
 * File: preset_core.dart
 * 
 * Description:
 * Defines composable, template-driven widget shells for the Quantum Design System 
 * using QPresetEngine. Implements robust JSON-configurable layouts for menus, 
 * lists, tables, media shells, and states.
 * 
 * Key Components:
 * - QPresetEngine.define: Maps declarative JSON layouts to Flutter slots and properties.
 * - Shell Definitions: surface_shell, rich_shell, list_item, menu_item, etc.
 * 
 * Dependencies/Relationships:
 * Part of quantum_omni_registry.dart.
 * 
 * Notes:
 * Allows for highly complex UI structures to be generated entirely via abstract data schemas.
 * ============================================================================
 */
part of '../quantum_omni_registry.dart';

void _registerRichDesignSystemPresets(QuantumVM vm) {
  ...
  QLBlueprint cloneNode(
    ...
    final Map<String, dynamic> json = preset.toJson();
    ...
    return QLBlueprint.fromJson(json, path: path ?? preset.debugPath);
  }
  ...
  List<QLBlueprint> buildRecursiveMenuItems(
    ...
    final QLBlueprint menuItemPreset =
        ctx.node.slots['item'] ?? bp(node('preset:menu_item'));
  ...
  List<QLBlueprint> buildRowsFromRecords(
    ...
    final QLBlueprint rowPreset =
        ctx.node.slots[slotName] ?? bp(node('preset:list_item'));
    return List<QLBlueprint>.generate(items.length, (int index) {
      final dynamic raw = items[index];
      final Map<String, dynamic> item = raw is Map
          ? Map<String, dynamic>.from(raw.cast<String, dynamic>())
      ...
      return cloneNode(
        ...
        children: children.isEmpty
            ? null
            : [
                bp(node('preset:rich_list', props: {
                  'items': children,
  ...
  QPresetEngine.define('surface_shell', layout: [
    'hook header header',
    'body body body',
  ...
  QPresetEngine.define('rich_shell', extendsAlias: 'surface_shell', layout: [
    'hook',
    'header',
    'toolbar',
    'content',
  ...
  QPresetEngine.define('item_shell', extendsAlias: 'surface_shell', layout: [
  ...
  QPresetEngine.define('cluster_shell', extendsAlias: 'surface_shell', layout: [
    'hook items items',
    'hook footer footer'
  ], defaultSlots: {
    'items': {'type': 'box:row'},
  ...
  QPresetEngine.define('split_shell', extendsAlias: 'surface_shell', layout: [
    'master detail'
  ], defaultSlots: {
    'master': {'type': 'box:col'},
    'detail': {'type': 'box:col'},
  ...
  QPresetEngine.define('state_shell', extendsAlias: 'surface_shell', layout: [
    'illustration',
    'title',
    'body',
    'actions',
  ...
  QPresetEngine.define('overlay_shell', extendsAlias: 'surface_shell', layout: [
    'backdrop panel'
  ], defaultSlots: {
  ...
  QPresetEngine.define('control_shell', extendsAlias: 'surface_shell', layout: [
  ...
  QPresetEngine.define('media_shell', extendsAlias: 'surface_shell', layout: [
    'media media',
    'caption meta',
    'overlay overlay'
  ], defaultSlots: {
  ...
  QPresetEngine.define('navigation_shell',
  ...
  QPresetEngine.define('menu_item', extendsAlias: 'item_shell', layout: [
    'hook trigger action',
  ...
  QPresetEngine.define('nested_menu', extendsAlias: 'cluster_shell', layout: [
    'hook',
    'items'
  ], defaultSlots: {
    'hook': {'type': 'hook:lifecycle'},
    'items': {'type': 'box:col'},
    'item': {'type': 'preset:menu_item'},
  ...
  QPresetEngine.define('list_item', extendsAlias: 'item_shell', layout: [
    'hook leading title trailing',
    'hook subtitle subtitle trailing',
    'content content content',
    'actions actions actions'
  ...
  QPresetEngine.define('rich_list', extendsAlias: 'collection_shell', layout: [
    'hook',
    'header',
    'items',
    'footer'
  ...
  QPresetEngine.define('table_row', extendsAlias: 'item_shell', layout: [
  ...
  QPresetEngine.define('rich_table', extendsAlias: 'collection_shell', layout: [
    'hook',
    'toolbar',
    'header',
    'rows',
  ...
  QPresetEngine.define('avatar_item', extendsAlias: 'item_shell', layout: [
    'hook avatar meta',
    'hook label label'
  ], defaultSlots: {
    'hook': {'type': 'hook:lifecycle'},
  ...
  QPresetEngine.define('avatar_group', extendsAlias: 'cluster_shell', layout: [
    'hook',
    'items',
    'footer'
  ], defaultSlots: {
    ...
    final List<QLBlueprint> avatarNodes =
      ...
      return cloneNode(
        ctx.node.slots['item'] ?? bp(node('preset:avatar_item')),
        props: <String, dynamic>{
          'item': item,
          'index': index,
          'hasMeta': (item['meta']?.toString() ?? '').isNotEmpty,
  ...
  QPresetEngine.define('category_browser',
  ...
  QPresetEngine.define('table_shell',
      extendsAlias: 'collection_shell',
      layout: [
        'hook hook hook',
  ...
  QPresetEngine.define('timeline_shell',
      extendsAlias: 'collection_shell',
      layout: [
        'hook header header',
        'rail items detail',
...
// ---- preset instance / registrations ----

Widget _buildPreset(QLContext rawCtx) {
  final String subType = rawCtx.resolvedSubType();
  if (subType.isEmpty) return const SizedBox.shrink();

  final def = QPresetEngine.getDef(subType);
  if (def == null) {
    return kDebugMode
        ? Text('Preset [$subType] not registered',
            style: const TextStyle(color: Colors.red))
        : const SizedBox.shrink();
  }

  return _QPresetInstanceNode(rawCtx: rawCtx, def: def);
}

class _QPresetInstanceNode extends StatefulWidget {
  final QLContext rawCtx;
  final PresetDef def;
  const _QPresetInstanceNode({required this.rawCtx, required this.def});

  @override
  State<_QPresetInstanceNode> createState() => _QPresetInstanceNodeState();
}

class _QPresetInstanceNodeState extends State<_QPresetInstanceNode> {
  ...
  Widget build(BuildContext context) {
    final presetCtx = QPresetContext(widget.rawCtx, widget.def, _instanceId);
    if (widget.def.nativeBuilder != null) {
      return widget.def.nativeBuilder!(presetCtx);
    }
    return presetCtx.buildLayout();
  }
}
...
void _registerPowerFieldPresets(QuantumVM vm) {
  QPresetEngine.define('field_shell', extendsAlias: 'control_shell', layout: [
    'label',
    'control',
    'helper',
    'error',
  ...
  QPresetEngine.define('popover_shell', extendsAlias: 'overlay_shell', layout: [
    'trigger',
    'panel'
  ], defaultSlots: {
  ...
  QPresetEngine.define('field_text', extendsAlias: 'field_shell', layout: [
    'label',
    'control',
    'helper',
    'error'
  ...
  QPresetEngine.define('field_number', extendsAlias: 'field_shell', layout: [
    'label',
    'control',
    'helper',
    'error'
  ...
  QPresetEngine.define('field_toggle', extendsAlias: 'field_shell', layout: [
    'control',
    'caption',
    'helper',
    'error'
  ...
  QPresetEngine.define('field_slider', extendsAlias: 'field_shell', layout: [
    'label',
    'slider',
    'value',
    'helper',
  ...
  QPresetEngine.define('field_select', extendsAlias: 'field_shell', layout: [
    'label',
    'trigger',
    'panel',
    'helper',
  ...
  QPresetEngine.define('field_array', extendsAlias: 'field_shell', layout: [
    'header',
    'items',
    'empty',
    'footer'
  ...
  QPresetEngine.define('field_blocks', extendsAlias: 'field_shell', layout: [
    'header',
    'blocks',
    'footer'
  ], defaultSlots: {
  ...
  QPresetEngine.define('field_data', extendsAlias: 'field_shell', layout: [
    'header',
    'body',
    'footer'
  ], defaultSlots: {
  ...
  QPresetEngine.define('field_lookup', extendsAlias: 'field_shell', layout: [
    'label',
    'control',
    'results',
    'helper',
  ...
  QPresetEngine.define('field_relation', extendsAlias: 'field_shell', layout: [
    'label',
    'control',
    'summary',
    'helper',
  ...
  QPresetEngine.define('field_shell_stacked',
  ...
  QPresetEngine.define('card_shell', extendsAlias: 'item_shell', layout: [
    'hook badge actions',
    'eyebrow title title',
    'media media media',
  ...
  QPresetEngine.define('workspace_shell',
      extendsAlias: 'surface_shell',
      layout: [
  ...
  QPresetEngine.define('inspector_shell',
  ...
  QPresetEngine.define('composer_shell',
  ...
  QPresetEngine.define('stage_shell', extendsAlias: 'surface_shell', layout: [
    'hud hud hud',
  ...
  QPresetEngine.define('wizard_shell',
...
// ────────────────────────────────────────────────────────────────────────────
void _registerBuiltInPresets(QuantumVM vm) {
  // ── 2. The Profile Card Preset (Variants + Hero + No Native Builder) ──
  QPresetEngine.define('profile_card', extendsAlias: 'item_shell', layout: [
    'avatar  name',
    'avatar  role',
    'stats   stats'
  ], defaultSlots: {
...
void _registerGeneralBuiltInPresets(QuantumVM vm) {
  QLBlueprint bp(Map<String, dynamic> json) => QLBlueprint.fromJson(json);
  ...
  String stateKey(QPresetContext ctx, String localName) {
  ...
  QPresetEngine.define('tabs', extendsAlias: 'navigation_shell', initialState: {
    'activeIndex': 0
  }, layout: [
    'hook',
    'tab_bar',
    ...
    'variant': {
      'underline': {
        'tab_bar': 'bg-transparent p-0 rounded-0 border-b-1 border-slate-200',
        'content': 'mt-0 pt-16'
      },
  ...
  QPresetEngine.define('segmented_control',
      extendsAlias: 'navigation_shell',
  ...
  QPresetEngine.define('accordion',
      extendsAlias: 'navigation_shell',
      initialState: {
        'openIndex': 0
      },
  ...
  QPresetEngine.define('search_panel', extendsAlias: 'control_shell', layout: [
  ...
  QPresetEngine.define('collection_shell',
      extendsAlias: 'surface_shell',
      layout: [
        'header header',
        'toolbar toolbar',
  ...
  QPresetEngine.define('form_panel', extendsAlias: 'control_shell', layout: [
    'header',
    'fields',
    'errors',
    'actions'
  ...
  QPresetEngine.define('master_detail', extendsAlias: 'split_shell', layout: [
    'master detail'
  ], defaultSlots: {
    'master': {'type': 'box:col'},
    'detail': {'type': 'box:col'}
  ...
  QPresetEngine.define('command_bar',
      extendsAlias: 'navigation_shell',
      layout: [
  ...
  QPresetEngine.define('media_card', extendsAlias: 'media_shell', layout: [
    'media media',
    'eyebrow meta',
    'title title',
    'body body',
  ...
  QPresetEngine.define('product_card', extendsAlias: 'item_shell', layout: [
    'media media',
    'badge badge',
    'title title',
    'price rating',
  ...
  QPresetEngine.define('transaction_row', extendsAlias: 'item_shell', layout: [
    'icon title amount',
  ...
  QPresetEngine.define('payment_method', extendsAlias: 'item_shell', layout: [
  ...
  QPresetEngine.define('feed_card', extendsAlias: 'item_shell', layout: [
    'author actions',
    'body body',
    'media media',
    'reactions reactions',
  ...
  QPresetEngine.define('state_surface', extendsAlias: 'state_shell', layout: [
    'illustration',
    'title',
    'body',
    'actions'
  ...
  QPresetEngine.define('metric_tile', extendsAlias: 'item_shell', layout: [
    'icon label trend',
    'value value trend',
    'footer footer footer'
  ], defaultSlots: {
  ...
  QPresetEngine.define('flow_shell', extendsAlias: 'split_shell', layout: [
    'chrome chrome',
    'sidebar content',
    'footer footer'
  ], defaultSlots: {
  ...
  QPresetEngine.define('hero_bridge', extendsAlias: 'split_shell', layout: [
    'source',
    'destination'
  ], defaultSlots: {
    'source': {'type': 'box:col'},
  ...
  for (final alias in const [
    ...
    vm.defineAlias(alias, 'preset:$alias');
  }
